...
RUN conda init bash && \
    ...
    conda install -n base -c conda-forge -c omnia cmake=3.28 python=3.8.19 signac=1.7.0 signac-flow=0.21.0 py3Dmol nglview openbabel=3.1.1 mbuild=0.10.5 jupyter mdanalysis=2.4.3 mdtraj=1.9.7 numpy=1.24.4 pandas=1.4.4 scikit-learn=1.3.2 scipy=1.10.1 -y && \
    pip install foyer==0.7.6 pyyaml && \
